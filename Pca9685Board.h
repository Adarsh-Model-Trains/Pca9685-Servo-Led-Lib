...
class Pca9685Board {
  ...
  private:
    ...
    int _totalLightBoard = 0;
    int _totalTurnoutBoard = 0;
    int _pwmFrequencyTurnout = 50;
    int _pwmFrequencyLight = 1000;
  ...
  public:
    ...
    void initPca9685Boards(int totalTurnoutBoard, int totalLightBoard);
